...
Future<bool> deleteSelectedPerformance(BuildContext context, String performanceId) async {

  final url = Uri.parse("${AppConstants.baseUrl}/delete_performance/$performanceId");
