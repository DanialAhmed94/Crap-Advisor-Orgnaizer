...
//
// class AddEventManagementView extends StatefulWidget {
//   const AddEventManagementView({super.key});
//
//   @override
//   _AddEventManagementViewState createState() => _AddEventManagementViewState();
// }
//
// class _AddEventManagementViewState extends State<AddEventManagementView> {
...
//     await Provider.of<EventProvider>(context, listen: false).fetchEvents(context);
//     try {
//       await Provider.of<InvoiceProvider>(context, listen: false).fetchInvoices(context);
//     } catch (error) {
//       print("Failed to fetch invoices in event management: $error");
//     }
//   }
//
//   @override
...
//                         Text("Add", style: TextStyle(height: 1.0, fontFamily: "UbuntuBold", fontSize: 28, color: Colors.white)),
//                         Text("Event", style: TextStyle(height: 1.0, fontFamily: "UbuntuBold", fontSize: 28, color: Colors.white)),
//                         Spacer(),
//                         GestureDetector(
...
//               child: Row(
//                 children: [
//                   Text("Events", style: TextStyle(fontSize: 16, fontFamily: "UbuntuMedium", fontWeight: FontWeight.bold)),
//                   SizedBox(width: MediaQuery.of(context).size.width * 0.49),
//                   TextButton(
//                     onPressed: () {
//                       Navigator.push(context, FadePageRouteBuilder(widget: AllEventsView()));
//                     },
//                     child: Text("View All", style: TextStyle(fontSize: 16, fontFamily: "UbuntuMedium", fontWeight: FontWeight.bold)),
//                   ),
//                 ],
//               ),
//             ),
...
//                     return Center(child: Text("Failed to load data: ${snapshot.error}", style: TextStyle(fontFamily: "UbuntuMedium", fontSize: 18)));
//                   } else {
//                     final events = Provider.of<EventProvider>(context).events;
//
//                     if (events.isEmpty) {
//                       return Center(child: Text("No events available!", style: TextStyle(fontFamily: "UbuntuMedium", fontSize: 18)));
//                     } else {
//                       final maxEventsToShow = 4;
...
//                                       width: 50.0,
//                                       height: 50.0,
//                                       decoration: BoxDecoration(color: Color(0xFFD3FCFF), shape: BoxShape.circle),
//                                       child: Center(
//                                         child: SvgPicture.asset(AppConstants.eventMangementCardIcon, height: 30, width: 30),
//                                       ),
//                                     ),
//                                   ),
//                                   Expanded(
//                                     child: Text(event.eventTitle ?? "No title", style: TextStyle(fontFamily: "UbuntuMedium", fontSize: 15, overflow: TextOverflow.ellipsis), maxLines: 2),
//                                   ),
//                                   Spacer(),
//                                   Padding(
...
//                                         child: Center(
//                                           child: Text("View Detail", textAlign: TextAlign.center, style: TextStyle(fontFamily: "UbuntuMedium", fontSize: 12, color: Colors.white)),
//                                         ),
//                                       ),
//                                     ),
//                                   ),
...
class AddEventManagementView extends StatefulWidget {
  ...
  @override
  State<AddEventManagementView> createState() => _AddEventManagementViewState();
}
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:Color(0xFF48CF51), // Background color
