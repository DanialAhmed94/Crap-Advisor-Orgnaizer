  ...
  Future<void> _handleUpdateEvent() async {
    ...
    try {
      ...
      if (_formKey.currentState!.validate()) {
        // Perform the update event operation
        await updateEvent(
          context,
        ...
        // Optionally, exit edit mode or perform other actions
        setState(() {
          _isEditMode = false;
        });
      }
    ...
    return Scaffold(
      body: Stack(
        children: [
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              readOnly:
                              !_isEditMode, // Editable in edit mode
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Row(
                                  mainAxisSize:
                                  MainAxisSize.min, // Ensures icon fits its space
                                  children: [
                                    Padding(
                                      padding:
                                    ...
                                    SizedBox(
                                        width:
                                        8), // Adds padding between the icon and content
                                  ],
                                ),
                                border: OutlineInputBorder(
                                  borderRadius:
          ...
          // Smooth Loading Overlay using AnimatedOpacity
        ],
      ),
    );
  }
