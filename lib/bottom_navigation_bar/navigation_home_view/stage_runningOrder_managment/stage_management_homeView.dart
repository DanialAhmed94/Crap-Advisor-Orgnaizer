...
class AddPerformanceHome extends StatefulWidget {
  const AddPerformanceHome({super.key});

  @override
  _AddPerformanceHomeState createState() => _AddPerformanceHomeState();
}

class _AddPerformanceHomeState extends State<AddPerformanceHome> {
  late Future<void> _fetchPerformancesFuture;

  @override
  void initState() {
    super.initState();
    // Initialize the future in initState
    _fetchPerformancesFuture =
          ...
          children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(context,
                          FadePageRouteBuilder(widget: AllPerformancesView()));
                    },
                    child: Text(
                      "View All",
                      style: TextStyle(
            ...
            Positioned(
              ...
              child: FutureBuilder<void>(
                future: _fetchPerformancesFuture,
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final performances =
                        Provider.of<PerformanceProvider>(context).performances;
                    ...
                    if (performances.isEmpty) {
                      ...
                      final performancesToShow =
                          performances.take(maxPerformancesToShow).toList();
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: SvgPicture.asset(AppConstants
                                            .performancesIcon), // Use your icon
                                      ),
                                    ),
                                  ),
                                  Expanded(
                                    child: Text(
                                      ...
                                      // Use performance title or any other field
                                      style: TextStyle(
                                        fontFamily: "UbuntuMedium",
                                        fontSize: 15,
